...
contract Web3KinzFurniture is ERC721, ERC721URIStorage, ERC721Burnable, Ownable {
    uint256 private _nextTokenId;

    constructor(address initialOwner)
        ERC721("Web3KinzFurniture", "Furniture")
    ...
    // borrowing from clothing from now
